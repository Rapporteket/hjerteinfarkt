...
dt <- rapbase::loadRegData(query=paste("SELECT * FROM hovedskjema_1 WHERE Innleggelsesaar>=2024;"))
...
text(seq(1,length(perioder),1),Andel60,labels=labels60,pos=1,cex=0.8)
